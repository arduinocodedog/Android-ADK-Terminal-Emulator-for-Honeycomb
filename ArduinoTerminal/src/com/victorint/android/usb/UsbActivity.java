...
public abstract class UsbActivity extends Activity implements Connectable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        registerForContextMenu(((TerminalViewable)currentViewable_).getContextMenuView());
	...
	public void onRestart() {
 	...
 	public boolean onOptionsItemSelected(MenuItem item) {
 		...
 		boolean selected = HandleMenuItemSelected(item);
 		if (!selected)
 	...
 	public boolean onContextItemSelected(MenuItem item) {
 		logMessage("onContextItemSelected");
 		boolean selected = HandleMenuItemSelected(item);
 		if (!selected)
